...
# Quizzes {background-color="#2d4563"}

## Quizzes {.quiz-question}

This template also contains the [`quiz` plugin](https://github.com/parmsam/quarto-quiz)
You can install it with `quarto install extension parmsam/quarto-quiz`
Add `{.quiz-question}` to a slide to create a question and `{.correct}` to the correct answer
...
# Text Resizer {background-color="#2d4563"}
